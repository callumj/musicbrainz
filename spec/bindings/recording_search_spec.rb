      ...
      expect(described_class.parse(Nokogiri::XML.parse(response).remove_namespaces!.xpath('/metadata'))).to eq [
        {
          ...
          title: 'King Fred', artist: 'Too Much Joy', releases: ['Green Eggs and Crack'], release_dates: ['2015-08-23'], score: 100
        }
      ]
    end
  end
